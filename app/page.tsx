...
// Closing-section echo: the full hero brain graphic (signal, nodes, labels),
// rendered smaller behind the contact actions.
        ...
        <section className="participate-section" id="participate">
          <div className="participate-panel">
            <div className="participate-copy">
              ...
              <p>
                Are you a University of Utah student? Join our participant pool
                to hear about upcoming studies on human judgment, artificial
                intelligence, and financial decision-making.
              </p>
              <small>
                Participation is voluntary. Eligibility and compensation vary
                by study.
              </small>
            </div>
            ...
            >
              ...
              <strong>Join the participant pool</strong>
              <p>Browse available studies and choose opportunities that interest you.</p>
